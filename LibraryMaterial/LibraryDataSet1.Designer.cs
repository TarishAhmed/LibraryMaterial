...
namespace LibraryMaterial {
    ...
    public partial class LibraryDataSet : global::System.Data.DataSet {
        ...
        public partial class QuestionDataTable : global::System.Data.TypedTableBase<QuestionRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public QuestionRow AddQuestionRow(string Question, int Mark) {
        ...
        public partial class QuestionRow : global::System.Data.DataRow {
            ...
            public int Mark {
                get {
                    try {
                        return ((int)(this[this.tableQuestion.MarkColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Mark\' in table \'Question\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableQuestion.MarkColumn] = value;
                }
            }
            ...
            public bool IsMarkNull() {
                return this.IsNull(this.tableQuestion.MarkColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetMarkNull() {
                this[this.tableQuestion.MarkColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace LibraryMaterial.LibraryDataSetTableAdapters {
    ...
    public partial class QuestionTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Question] WHERE (([Id] = @Original_Id) AND ((@IsNull_Mark = 1 " +
                "AND [Mark] IS NULL) OR ([Mark] = @Original_Mark)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Question] ([Question], [Mark]) VALUES (@Question, @Mark);\r\nSEL" +
                "ECT Id, Question, Mark FROM Question WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Question] SET [Question] = @Question, [Mark] = @Mark WHERE (([Id] =" +
                " @Original_Id) AND ((@IsNull_Mark = 1 AND [Mark] IS NULL) OR ([Mark] = @Original" +
                "_Mark)));\r\nSELECT Id, Question, Mark FROM Question WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Question, Mark FROM dbo.Question";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT Id, Question, Mark FROM dbo.Question";
        ...
        public virtual int FillBy(LibraryDataSet.QuestionDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, global::System.Nullable<int> Original_Mark) {
        ...
        public virtual int Insert(string Question, global::System.Nullable<int> Mark) {
            if ((Question == null)) {
        ...
        public virtual int Update(string Question, global::System.Nullable<int> Mark, int Original_Id, global::System.Nullable<int> Original_Mark, int Id) {
            if ((Question == null)) {
            ...
            if ((Original_Mark.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(Original_Mark.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Question, global::System.Nullable<int> Mark, int Original_Id, global::System.Nullable<int> Original_Mark) {
            return this.Update(Question, Mark, Original_Id, Original_Mark, Original_Id);
        }
    }
